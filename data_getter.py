...
from rnaloops.data_getter.getter_fcts import *
...
prepare_data = True     # seconds (just reads df from pkl and modifies it)
...
# This downloads the pdfs, see data_getter/getter_fcts for details:
if download_pdfs:
...
if parse_pdfs:
    ...
    joblib.dump(df, 'rnaloops/data/rnaloops_data.pkl')
...
# This prepares the data a bit and save it as rnaloops_data_prepared.pkl,
# check data_getter.getter_fcts.prepare_df for details:
if prepare_data:
    prepare_df()
